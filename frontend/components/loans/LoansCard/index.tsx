          ...
          {activeLoans.map((loan) => (
            ...
            >
              <div className="p-4 rounded-lg md:border-none border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 relative hover:shadow-sm">
                <div className="absolute right-4 top-4 px-2 py-1 rounded-full text-xs font-medium bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-800">
                  Active Loan
                </div>

                <div className="flex items-start mb-6">
                  <div className="flex items-center gap-3 flex-1">
                    <div className="h-12 w-12 md:h-10 md:w-10 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 flex items-center justify-center flex-shrink-0">
                      <span className="text-blue-600 dark:text-blue-400 font-medium text-lg md:text-base">
                        {loan.collateral[0]}
                      </span>
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 border md:border-none  border-gray-100 dark:border-gray-700">
